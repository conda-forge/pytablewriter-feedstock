...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytablewriter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10450&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytablewriter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytablewriter` can be installed with:

```
conda install pytablewriter
```

It is possible to list all of the versions of `pytablewriter` available on your platform with:
